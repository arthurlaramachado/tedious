...
**Tedious** is an interactive terminal task manager written in **Go** using the [Bubble Tea](https://github.com/charmbracelet/bubbletea) framework.

The project allows you to create, navigate, and toggle tasks directly in the terminal, supporting multiple states:

- **Unmarked** – task not started  
